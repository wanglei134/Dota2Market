...
window.onload=function (){
  ...
  <tr align="center" valign="middle" bordercolor="#999999" >
    ...
    <td height="28" colspan="3" align="left" background="image/emailheader.jpg" style="border:0;" class="STYLE5" >(共 <span class="STYLE12">${count }</span> 封收文，其中未读收文<span class="STYLE12">${unread }</span> 封)</td>
  </tr>
